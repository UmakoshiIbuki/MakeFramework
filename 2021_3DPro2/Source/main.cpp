                     ...
                     _In_ int       nCmdShow)
{
   ...
   /* LoadStringW(hInstance, IDS_APP_TITLE, szTitle, MAX_LOADSTRING);
    LoadStringW(hInstance, IDC_MY20213DPRO2, szWindowClass, MAX_LOADSTRING);*/
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszClassName  = L"2021_3DPro2";
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(L"2021_3DPro2", L"2021_3DPro2", WS_OVERLAPPEDWINDOW,
   ...
   std::string err;
   D3D.Create(hWnd, 1280, 720, false, true, err);
